...
public interface StompServer {
	...
	default long outgoingHeartbeatMilliseconds() {
		return 0L;
	}

	default long incomingHeartbeatMilliseconds() {
		return 0L;
	}
	 ...
	 */
	default @NonNull Mono<Void> doOnEachInboundFrame(final @NonNull StompSession session, final @NonNull StompFrame inbound) {
		return Mono.empty();
	}
	 ...
	 */
	default @NonNull Mono<Void> doOnEachOutboundFrame(final @NonNull StompSession session, final @NonNull StompFrame outbound) {
		return Mono.empty();
	}

	/**
	 * Adds consumer for each inbound STOMP heartbeat.
	 *
	 * @param session The associated STOMP session.
	 */
	default @NonNull Mono<Void> doOnEachInboundHeartbeat(final @NonNull StompSession session) {
		return Mono.empty();
	}

	/**
	 * Adds consumer for each outbound STOMP heartbeat.
	 *
	 * @param session The associated STOMP session.
	 */
	default @NonNull Mono<Void> doOnEachOutboundHeartbeat(final @NonNull StompSession session) {
		return Mono.empty();
	}
	 ...
	 * @see StompServer#onError(StompSession, StompFrame, Map, Map, StompFrame)
	 */
	default @NonNull Mono<Void> doFinally(final @NonNull StompSession session, final @Nullable Map<String, Tuple2<AckMode, Queue<String>>> subscriptionCache, final @Nullable Map<String, StompFrame> frameCache) {
		return Mono.empty();
	}
	 ...
	 */
	default @NonNull Mono<StompFrame> onStomp(final @NonNull StompSession session, final @NonNull StompFrame inbound, final @NonNull Version version, final @NonNull String host, final @NonNull StompFrame outbound) {
	 ...
	 * @return The final outbound STOMP frame.
	 */
	default @NonNull Mono<StompFrame> onConnect(final @NonNull StompSession session, final @NonNull StompFrame inbound, final @NonNull Version version, final @NonNull String host, final @NonNull StompFrame outbound) {
		return Mono.just(outbound);
	}
	 ...
	 * @return The final outbound STOMP frame.
	 */
	default @NonNull Mono<StompFrame> onSend(final @NonNull StompSession session, final @NonNull StompFrame inbound, final @NonNull String destination, final @Nullable StompFrame outbound) {
	 ...
	 * @return The final outbound STOMP frame.
	 */
	default @NonNull Mono<StompFrame> onSubscribe(final @NonNull StompSession session, final @NonNull StompFrame inbound, final @NonNull String destination, final @NonNull String subscriptionId, final @Nullable StompFrame outbound) {
		return Mono.justOrEmpty(outbound);
	}
	 ...
	 * @return The final outbound STOMP frame.
	 */
	default @NonNull Mono<StompFrame> onUnsubscribe(final @NonNull StompSession session, final @NonNull StompFrame inbound, final @NonNull String subscriptionId, final @Nullable StompFrame outbound) {
		return Mono.justOrEmpty(outbound);
	}
	 ...
	 * @return The final outbound STOMP frame.
	 */
	default @NonNull Mono<StompFrame> onAck(final @NonNull StompSession session, final @NonNull StompFrame inbound, final @NonNull String subscription, final @NonNull String id, final @NonNull List<StompFrame> ackMessages, final @Nullable StompFrame outbound) {
		return Mono.justOrEmpty(outbound);
	}
	 ...
	 * @return The final outbound STOMP frame.
	 */
	default @NonNull Mono<StompFrame> onNack(final @NonNull StompSession session, final @NonNull StompFrame inbound, final @NonNull String subscription, final @NonNull String id, final @NonNull List<StompFrame> nackMessages, final @Nullable StompFrame outbound) {
		return Mono.justOrEmpty(outbound);
	}
	 ...
	 * @return The final outbound STOMP frame.
	 */
	default @NonNull Mono<StompFrame> onBegin(final @NonNull StompSession session, final @NonNull StompFrame inbound, final @NonNull String transaction, final @Nullable StompFrame outbound) {
		return Mono.justOrEmpty(outbound);
	}
	 ...
	 * @return The final outbound STOMP frame.
	 */
	default @NonNull Mono<StompFrame> onCommit(final @NonNull StompSession session, final @NonNull StompFrame inbound, final @NonNull String transaction, final @Nullable StompFrame outbound) {
		return Mono.justOrEmpty(outbound);
	}
	 ...
	 * @return The final outbound STOMP frame.
	 */
	default @NonNull Mono<StompFrame> onAbort(final @NonNull StompSession session, final @NonNull StompFrame inbound, final @NonNull String transaction, final @Nullable StompFrame outbound) {
		return Mono.justOrEmpty(outbound);
	}
	 ...
	 * @see StompServer#onError(StompSession, StompFrame, Map, Map, StompFrame)
	 */
	default @NonNull Mono<StompFrame> onDisconnect(final @NonNull StompSession session, final @NonNull StompFrame inbound, final @Nullable Map<String, Tuple2<AckMode, Queue<String>>> subscriptionCache, final @Nullable Map<String, StompFrame> frameCache, final @Nullable StompFrame outbound) {
		return Mono.justOrEmpty(outbound);
	}
